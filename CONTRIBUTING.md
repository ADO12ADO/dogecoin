# Contributing to Nicoin Core

Nicoin Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/nicoin/nicoin/labels/help%20wanted)
* [Projects](https://github.com/nicoin/nicoin/projects)
* [Nicoindev on reddit](https://www.reddit.com/r/nicoindev/)

## Branch Strategy

Nicoin Core's default branch is intentionally a stable release, so that anyone
...
Nicoin Core is a direct fork of Bitcoin Core and therefore benefits from as
...
[bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) and future Nicoin Core
releases will automatically benefit from these.

When refactoring Nicoin-specific code, please keep refactoring requests short,
low complexity and easy to verify.


## "Decision Making" Process

The following applies to code changes to Nicoin Core, and is not to be
confused with overall Nicoin Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into Nicoin Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of Nicoin; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards Nicoin
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the Nicoin consensus, it must have been
