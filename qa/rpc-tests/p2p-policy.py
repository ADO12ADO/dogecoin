#!/usr/bin/env python3
# Copyright (c) 2021-2022 The Nicoin Core developers
...
class P2PPolicyTests(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        # a Nicoin Core node that behaves similar to mainnet policies
    ...
    def run_test(self):
        ...
        ### test constants ###
        koinu = Decimal("0.00000001")          # 1 Koinu expressed in NI
        ten = Decimal("10.0")                  # uniform 10 NI seed moneys
        ...
        # create a bunch of UTXO with seed money from the Nicoin Core wallet
        for i in range(20):
        ...
        # test legacy output of 1 NI output and 1 NI fee
    ...
    # spend seed money with a key not in the Nicoin Core wallet.
    def spend_utxo(self, output, expected_size, retries=0):
        # construct the transaction using Nicoin Core raw tx APIs
        ...
        # and send the tx from there rather than from Nicoin Core, to test
