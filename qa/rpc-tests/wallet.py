...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210.000 NI from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1.000.000 ni in block rewards plus fees, but
        ...
        # Send 100000 NI with subtract fee from amount
