...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s nicoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  nicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nicoin transaction") + "\n" +
              "  nicoin-tx [options] -create [commands]   " + _("Create hex-encoded nicoin transaction") + "\n" +
              "\n";
