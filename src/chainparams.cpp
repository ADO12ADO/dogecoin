...
public:
    CMainParams() {
        ...
        // BIP34 is never enforced in Nicoin v2 blocks, so we enforce from v3
        ...
        // XXX: BIP heights and hashes all need to be updated to Nicoin values
        ...
        vSeeds.push_back(CDNSSeedData("multini.org", "seed.multini.org", true));
        vSeeds.push_back(CDNSSeedData("multini.org", "seed2.multini.org"));
