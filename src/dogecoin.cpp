...
// Nicoin: Normally minimum difficulty blocks can only occur in between
...
unsigned int CalculateNicoinNextWorkRequired(const CBlockIndex* pindexLast, int64_t nFirstBlockTime, const Consensus::Params& params)
{
...
CAmount GetNicoinBlockSubsidy(int nHeight, const Consensus::Params& consensusParams, uint256 prevHash)
{
