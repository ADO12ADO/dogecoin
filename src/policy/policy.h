...
/** Recommended transaction fee by Nicoin Core developers
  *
 ...
 *
 *  Nicoin:    Increment mempool limits and accept RBF in steps of 0.0001 NI
...
/**
 * Nicoin: Default dust limit that is evaluated when considering whether a
...
/**
 * Nicoin: Default hard dust limit that is evaluated when considering whether
