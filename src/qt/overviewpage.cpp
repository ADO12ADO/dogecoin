...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Nicoin Core repository on GitHub"),
        tr("Services that claim to double your nicoins are always ponzi schemes")
    };
