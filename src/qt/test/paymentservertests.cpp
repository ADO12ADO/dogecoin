...
// Copyright (c) 2020 The Nicoin Core developers
...
void PaymentServerTests::paymentServerTests()
{
    ...
    // Nicoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for Nicoin (as there is no actual maximum coins)
